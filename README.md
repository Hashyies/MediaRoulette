...
### Roadmap
[ ] Discord bot for recieving images
[ ] Adding a variety of popular subreddits
[ ] Create probability table for RandomImage for integration with other parts of the project
[ ] Create a webhook/database system for receiving NSFW rating and storing them.
[ ] Allow users to use their own Reddit API keys.
